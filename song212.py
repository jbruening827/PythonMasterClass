...
class Album:
    ...
    def add_song(self, song, position=None):
        ...
        Args:
            ...
            to that position in the tracklist - between others if necessary.
            Otherwise, the song will be ended to the end of the list.
        """
        if position is None:
...
class Artist:
    ...
    Attributes:
        ...
        albums (List[Album]): A list of the albums by this artists.
            The includes only the albums in this collection, it is not
...
def find_object(field, object_list):
    ...
    to field exists, and return it if so."""
    ...
    with open("albums.txt", "r") as albums:
        for line in albums:
            ...
            if new_artist is None:
                ...
                # otherwise create new artist object and add it to artist list.
            ...
            if new_album is None:
                ...
                # Retrieve the album object if there is one, otherwise
                # create new album object and store it in the artist's collection
